...
export class AppConfigurator implements OnInit {
    ...
    selectedTheme = computed(() => this.layoutService.layoutConfig().theme ?? 'system');
    ...
    ngOnInit() {
        ...
        this.translateService.onLangChange.subscribe(() => {
            this.themeOptions = [
                { label: this.translateService.instant("system"), value: 'system', icon: 'pi pi-desktop' },
                { label: this.translateService.instant("light"), value: 'light', icon: 'pi pi-sun' },
                { label: this.translateService.instant("dark"), value: 'dark', icon: 'pi pi-moon' }
            ];

            this.menuModeOptions = [
                { label: this.translateService.instant('static'), value: 'static' },
                { label: this.translateService.instant('overlay'), value: 'overlay' }
            ];
        });
    }
    ...
    onThemeChange(value: string) {
        this.layoutService.layoutConfig.update((state) => ({ ...state, theme: value }));
    }
